 ...
 */
public class UiSettingsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
        if( !checkMyPermission(getBaseContext()))
            return;
    ...
    public void setMyLocationLayerEnabled(View v) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            PermUtils.requestPermission(this, LOCATION_LAYER_PERMISSION_REQUEST_CODE,
    ...
    public void requestLocationPermission(int requestCode) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            PermUtils.RationaleDialog
                    .newInstance(requestCode, false).show(
                    getSupportFragmentManager(), "dialog");
        } else {
            // Location permission has not been granted yet, request it.
            PermUtils.requestPermission(this, requestCode,
                    Manifest.permission.ACCESS_FINE_LOCATION, false);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == MY_LOCATION_PERMISSION_REQUEST_CODE) {
            ...
            if (PermUtils.isPermissionGranted(permissions, grantResults, Manifest.permission.ACCESS_FINE_LOCATION)) {
    ...
    protected void onResumeFragments() {
        ...
        if (mLocationPermissionDenied) {
            PermUtils.PermissionDeniedDialog
