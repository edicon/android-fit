...
public class RecordActivity extends AppCompatActivity {
        ...
        mClient = new GoogleApiClient.Builder(this)
                ...
                .enableAutoManage(this, 0, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(ConnectionResult result) {
                        ...
                        Snackbar.make(
                                RecordActivity.this.findViewById(R.id.main_activity_view),
    ...
    public void subscribe() {
        ...
        Fitness.RecordingApi.subscribe(
                ...
                // DataType.TYPE_STEP_COUNT_CUMULATIVE) // ToDo: for Step Count
                // DataType.TYPE_LOCATION_SAMPLE)       // ToDo: for Location Sample
                // DataType.TYPE_LOCATION_TRACK)        // ToDo: for Location Track
