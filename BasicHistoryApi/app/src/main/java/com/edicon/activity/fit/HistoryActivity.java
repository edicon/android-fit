...
import com.edicon.activity.location.LocationService;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    private class InsertAndVerifyDataTask extends AsyncTask<Void, Void, Void> {
        protected Void doInBackground(Void... params) {
            ...
            printLocationData(dataReadResult);
    ...
    public static void printLocationData(DataReadResult dataReadResult) {
        Log.i(TAG, "\nDump Localtion Data: ");
        printData(dataReadResult);
    }
    ...
    private static void dumpStepData(DataSet dataSet) {
        ...
        for (DataPoint dp : dataSet.getDataPoints()) {
            ...
            Log.i(TAG, "\tOrg.DataSource: " + dp.getOriginalDataSource().getAppPackageName());
    ...
    public static DataReadRequest queryLocationData() {
        ...
        DataReadRequest readRequest = new DataReadRequest.Builder()
                ...
                // datapoints each consisting of a few steps and a timestamp.  The more likely
                // scenario is wanting to see how many steps were walked per day, for 7 days.
                // .aggregate(DataType.TYPE_LOCATION_TRACK, DataType.AGGREGATE_LOCATION_BOUNDING_BOX)
